...
extern "C" void ui_nav_set_brightness(uint8_t pct)
{
    app_runtime_get()->display_brightness = pct;
    bsp_display_brightness_set(pct);
}

extern "C" void ui_nav_apply_dim(bool dim)
{
...
extern "C" void ui_nav_aa_new_maths(void)
{
    aa_generate_maths();
}
...
extern "C" void ui_nav_go(ui_screen_id_t screen)
{
...
extern "C" ui_screen_id_t ui_nav_current(void)
{
    return s_current;
}

extern "C" aa_session_t *ui_nav_aa_session(void)
{
    return &s_aa;
}

extern "C" void ui_nav_reset_idle_timer(void)
{
    const app_config_t *cfg = app_config_get();
    switch (s_current) {
    case UI_SCREEN_SPLASH:
...
extern "C" void ui_nav_aa_touch(void)
{
    s_aa.last_input_ms = now_ms();
    ui_nav_reset_idle_timer();
}
...
extern "C" void ui_nav_start_aa(ui_screen_id_t entry, ui_screen_id_t on_pass)
{
    const app_config_t *cfg = app_config_get();
...
extern "C" void ui_nav_aa_pass(void)
{
...
extern "C" void ui_nav_aa_cancel(void)
{
