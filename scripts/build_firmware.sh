...
CMAKE_VERSION_FILE="${ROOT}/cmake/firmware_version.cmake"
...
source "${ROOT}/scripts/lib_firmware_version.sh"
...
if [[ "${DO_UPLOAD}" == "true" ]]; then
  ...
  "${ROOT}/scripts/upload_firmware.sh" --version "${FIRMWARE_VERSION_DIR}" --file "${OUT_DIR}/${PROJECT_NAME}.bin"
fi
